  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-8 mb-8">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-3">Номер для заказа</h3>
          <a
            href="tel:+996504777717"
            className="text-[#009B3E] hover:text-[#007a31] font-medium text-xl"
          >
            +996 504 777 717
          </a>
        </div>
        ...
        <div className="mt-6">
          ...
          <p className="text-gray-600 mb-4">
            Мы ценим каждого нашего клиента, поэтому мы даём гарантию на нашу продукцию:
          </p>
          <ul className="space-y-2 text-gray-700">
            <li>
              • Санфарфор (раковины, унитазы, биде) – <strong>10 лет</strong>
            </li>
            <li>
              • Ванны – <strong>10 лет</strong>
            </li>
            <li>
              • Смесители – <strong>3 года</strong>
            </li>
            <li>
              • Инсталяция – <strong>3 года</strong>
            </li>
            <li>
              • Водонагреватели – <strong>на бак 3 года, на тен 1 год</strong>
            </li>
          </ul>
        </div>
      </div>
