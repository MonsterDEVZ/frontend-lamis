...
const waterHeaters = [
  {
    ...
    alt: 'Водонагреватель Blesk в интерьере 1',
  },
  {
    id: 2,
    image: '/images/water-heaters/2.png',
    alt: 'Водонагреватель Blesk в интерьере 2',
  },
  {
    id: 3,
    image: '/images/water-heaters/3.png',
    alt: 'Водонагреватель Blesk в интерьере 3',
  },
  {
    id: 4,
    image: '/images/water-heaters/4.png',
    alt: 'Водонагреватель Blesk в интерьере 4',
  },
];
          ...
          {waterHeaters.map((heater) => (
            ...
            >
              ...
              <div className="absolute bottom-6 left-6">
                <span className="text-white font-medium text-lg">Blesk</span>
              </div>
            </div>
          ))}
        </div>
