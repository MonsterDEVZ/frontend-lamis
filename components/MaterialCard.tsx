            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  ...
                  className="flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-full text-gray-600 hover:bg-green-100 hover:text-white hover:border-green-100 transition-all duration-300"
                >
                  <Download size={20} />
                </a>
              </TooltipTrigger>
