...
export const MOCK_TUTORIALS_DATA: Record<string, TutorialCategory> = {
  ...
  "furniture-installation": {
    ...
    pageBannerUrl: "https://images.unsplash.com/photo-1592078615290-033ee584e267?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920",
    videos: [
  ...
  "sink-installation": {
    ...
    pageBannerUrl: "https://images.unsplash.com/photo-1601121141499-17ae80afc03a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920",
    videos: [
  ...
  "bath-installation": {
    ...
    pageBannerUrl: "https://images.unsplash.com/photo-1586798271654-0471bb1b0803?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920",
    videos: [
  ...
  "faucet-installation": {
    ...
    pageBannerUrl: "https://images.unsplash.com/photo-1616763484369-964a4b7a6733?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920",
    videos: [
  ...
  "water-heater-installation": {
    ...
    pageBannerUrl: "https://images.unsplash.com/photo-1621038943537-33129b797855?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920",
    videos: [
